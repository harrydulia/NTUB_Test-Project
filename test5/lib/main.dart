...
class LoginWidget extends StatelessWidget {
  LoginWidget({Key? key}) : super(key: key);
      ...
      color : Color.fromRGBO(185, 185, 185, 0.5799999833106995),
  )
      )
      ),Positioned(
        top: 350,
      ...
      child: Stack(
        ...
        top: 11,
        left: 31,
        child: Text('登入', textAlign: TextAlign.center, style: TextStyle(
        color: Color.fromRGBO(134, 13, 13, 1),
      ...
      color : Color.fromRGBO(207, 199, 18, 0.3400000035762787),
      border : Border.all(
          color: Color.fromRGBO(255, 255, 255, 1),
          width: 1,
        ),
      ...
      color : Color.fromRGBO(255, 255, 255, 0.8600000143051147),
      border : Border.all(
      ...
      border : Border.all(
        ...
        left: 27.2098388671875,
        child: Text('我的密碼', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(181, 181, 181, 1),
        fontFamily: 'HanWangKaiMediumChuIn',
        fontSize: 26,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
        ...
        child: Text('忘記密碼了嗎？趕快找輔導老師確認！', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(224, 16, 16, 0.7599999904632568),
        fontFamily: 'HanWangKaiMediumChuIn',
        fontSize: 24,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
        fontWeight: FontWeight.normal,
